export class ClientsPage {
  ...
  clickonclients() {
    cy.get(".align-items-center.flex.justify-content-center.pi.pi-users.size-16.text-white.ng-star-inserted")
  ...
  validateClientspage() {
    cy.get("div[class='text-base font-semibold line-height-3 text-900']").should("be.visible").and("contain.text", "All Clients");
